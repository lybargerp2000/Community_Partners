...
namespace CommunityPartners.Controllers
{
    public class AdminsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AdminId,IdentityUserId,FirstName,LastName,PartnerId")] Admin admin)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("AdminId,IdentityUserId,FirstName,LastName,PartnerId")] Admin admin)
        {
            if (id != admin.AdminId)
            {
                return NotFound();
